    ...
    initial_parameters = {
        "excitation_energy": {
            ...
            "description": (
                ...
                "material. Even if this is a bold assumption, we set it equal "
                "to the material work function, which must be given."
            ),
        },
        "diffusion_length": {
            "markdown": "d",
...
def range_func(
    ...
    **kwargs,
    ...
    .. note::
       ...
       constant. See Ref. :cite:`Inguimbert2017` for an alternative model.
